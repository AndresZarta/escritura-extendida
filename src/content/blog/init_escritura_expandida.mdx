---
title: "init_escritura_expandida"
pubDate: 2025-11-10
description: "Un ensayo sobre la escritura::extendida: la búsqueda de una literatura que combine pensamiento, código y sensibilidad, explorando cómo el lenguaje puede expandirse en el entorno digital sin perder su profundidad estética."
image: "src/assets/images/init_escritura_expandida/thumbnail.png"
draft: false
---
import { Image } from 'astro:assets';
import andy_website from '../../assets/images/init_escritura_expandida/andy_matushak.png';
import TriColor from '../../components/TriColor.astro';


```javascript
// init: viene de _initialize_ y significa el punto cero donde toda ejecución arranca.
```
...
## .que_es_este_blog?
Este blog es un proyecto digital propio construido con tecnologías abiertas y servicios públicos de publicación.
