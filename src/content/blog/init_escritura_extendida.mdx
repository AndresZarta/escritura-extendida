...
Fue desarrollado de forma independiente a partir de un proceso largo de experimentación y aprendizaje técnico. Utiliza **[GitHub](/notes/github) y GitHub Pages** para gestionar versiones y publicar el contenido, y se apoya en **Astro**, que permite combinar contenido estático con componentes interactivos. Esta escrito en **HTML, CSS y JavaScript/Typescript**.
