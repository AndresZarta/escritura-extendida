...
Arquitectónicamente, la mayoría de los CMS tradicionales —como WordPress— generan [[sitios_web_dinamicos|sitios web dinámicos]]: el contenido se almacena en una base de datos y cada página se construye en tiempo de ejecución mediante plantillas y lógica del servidor. El HTML que recibe el navegador no existe como un documento estable, sino como el resultado ensamblado de múltiples capas del sistema.
